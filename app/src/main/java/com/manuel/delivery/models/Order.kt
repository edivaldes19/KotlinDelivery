...
class Order(
    ...
    @SerializedName(Constants.PROP_STATUS) var status: String = Constants.VALUE_PAID_OUT,
    ...
    override fun toString(): String =
        "Order(id=$id, idClient='$idClient', idDelivery=$idDelivery, idAddress='$idAddress', status=$status, timestamp='$timestamp', listOfProducts=$listOfProducts, client=$client, address=$address)"
