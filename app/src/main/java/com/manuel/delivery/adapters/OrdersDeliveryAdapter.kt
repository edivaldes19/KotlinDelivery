...
import com.manuel.delivery.activities.delivery.orders.detail.DeliveryOrdersDetailActivity
...
class OrdersDeliveryAdapter(
...
) : RecyclerView.Adapter<OrdersDeliveryAdapter.OrderViewHolder>() {
    ...
    override fun onBindViewHolder(holder: OrderViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            context.startActivity(Intent(context, DeliveryOrdersDetailActivity::class.java).apply {
